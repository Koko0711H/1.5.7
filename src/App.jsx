...
import "./App.css"
import { PRODUCT } from "./productConfig.js"
  ...
  const renderRightContent = (stage, idx) => {
    ...
    return (
      <div className={"anim-block " + ac} key={stage.id}>
        ...
        {isE && (
          <div>
            <img className="engine-img" src="/images/engine-new.jpg" alt="动力系统" />
        ...
        {isAf && (
          <div className="airflow-top-right text-block-animate">
            <img className="module-img" src="/images/airflow-new.jpg" alt="气流设计" />
            <p className="airflow-desc-text">{t("airflowDesc")}</p>
          </div>
        )}
        {isC && (
          <div className="chassis-right text-block-animate">
            <img className="module-img chassis-img" src="/images/chassis-new.jpg" alt="减震设计" />
      ...
      <div className="scene">
        <Canvas
          ...
          <Suspense fallback={null}>
            <ModelGroup url={PRODUCT.modelUrl} progress={progress} />
          </Suspense>
          <Particles />
          <LightingController />
      ...
      <div className="ui-layer">
        <div className="tech-tags">
          {PRODUCT.stats.map((stat) => (
            <div className="tech-tag" key={stat.label}>{stat.value}<span className="label">{stat.label}</span></div>
          ))}
        </div>
...
<ScrollHint show={ready} progress={progress} />
      ...
      <div className="bottom-info">{PRODUCT.footer.copyright}</div>
      <div className="bottom-info-left">{PRODUCT.footer.series}</div>
